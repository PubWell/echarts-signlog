...
import SignLogScale from './SignLog';
...
export function isIntervalOrLogScale(scale: Scale): scale is LogScale | IntervalScale | SignLogScale {
    return scale.type === 'interval' || scale.type === 'log' || scale.type === 'signlog';
}
/**
